...
function verificarChute() {
    ...
    if (chute == numeroSecreto) {
        ...
        if (chute > numeroSecreto) {
            exibirTextoNaTela('p', 'Errou, o numero secreto é menor');
        }else{
            exibirTextoNaTela('p', 'Errou, o numero secreto é maior');
        }
        tentativas++;
        limparCampo();
    }
...
function gerarNumeroAleatorio() {
    ...
    // Limpa a lista de números sorteados se já tiver 4 elementos
